    ...
    render(){
        return(
           ...
           >
            ...
            {this.renderSection(this.state.herLocation,
...
const styles = {
    ...
    section: {
        ...
        width:width*0.59,
        height:height*0.045,
       /*flexDirection:'row' ,*//*react ta herşey alt alta gelir yanına getirmek için bu kod kullanılır.*/
        alignItems:'center',
        /*justifyContent:'space-between',*//*en uçlara çek demek*/
        paddingLeft:10,
        paddingRight:10
